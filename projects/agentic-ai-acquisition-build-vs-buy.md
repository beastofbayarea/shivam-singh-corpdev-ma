# Agentic AI Acquisition - Build-vs-Buy and Integration Strategy

## How I frame the project

I developed this case study to show how I would lead the work behind **Agentic AI Acquisition - Build-vs-Buy and Integration Strategy** from an ambiguous starting point to an evidence-based decision and an executable plan. I place it in the context of my [AWS experience from July 2024 to present](https://github.com/beastofbayarea/shivam-singh-corpdev-ma/blob/main/shivam-singh-corpdev-ma.pdf).
...
I use [NIST - Generative AI Profile (2024)](https://doi.org/10.6028/NIST.AI.600-1) to ground generative AI risk and evaluation foundation. I use [NIST - Cybersecurity Framework 2.0 (2024)](https://doi.org/10.6028/NIST.CSWP.29) to ground governance, cybersecurity, and supply-chain risk framework.

## What I would set out to accomplish

- I would compare build, partner, minority investment, and acquisition against the same strategic capabilities.
- I would diligence model provenance, data rights, evaluation quality, tool permissions, security, and customer concentration.
- I would value reusable technology and distribution separately from uncertain agent autonomy claims.
- I would define integration gates for identity, policy, telemetry, incident response, and customer migration before closing.
...
|---|---|
| I would track verified capability coverage | I would use this to expose evidence gaps before they turn into confident but incorrect decisions. |
| I would track unresolved rights issues | I would baseline this measure, assign an owner, review it by cohort or operating segment, and connect movement to a specific decision or corrective action. |
| I would track security findings | I would use this to understand control effectiveness, severity, recurrence, and whether I need to stop, narrow, or redesign the rollout. |
| I would track integration dependencies | I would baseline this measure, assign an owner, review it by cohort or operating segment, and connect movement to a specific decision or corrective action. |
| I would track retention risk | I would use this to understand control effectiveness, severity, recurrence, and whether I need to stop, narrow, or redesign the rollout. |
| I would track value sensitivity | I would use this to test whether the operating model creates durable value after implementation, risk, and support costs are included. |
...
|---|---|
| [NIST - Generative AI Profile (2024)](https://doi.org/10.6028/NIST.AI.600-1) | I use this source to ground generative AI risk and evaluation foundation. |
| [NIST - Cybersecurity Framework 2.0 (2024)](https://doi.org/10.6028/NIST.CSWP.29) | I use this source to ground governance, cybersecurity, and supply-chain risk framework. |
