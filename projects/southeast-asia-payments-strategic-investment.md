# Southeast Asia Payments - Strategic Investment

## How I frame the project

I developed this case study to show how I would lead the work behind **Southeast Asia Payments - Strategic Investment** from an ambiguous starting point to an evidence-based decision and an executable plan. I place it in the context of my [Rakuten experience from June to December 2023](https://github.com/beastofbayarea/shivam-singh-corpdev-ma/blob/main/shivam-singh-corpdev-ma.pdf).
...
I use [World Bank - Fast Payments Toolkit (2021)](https://fastpayments.worldbank.org/sites/default/files/2021-11/Fast%20Payment%20Flagship_Final_Nov%201.pdf) to ground market and implementation framework for fast payments, QR, APIs, risk, and interoperability. I use [PCI SSC - PCI DSS 4.0 release (2022)](https://www.pcisecuritystandards.org/about_us/press_releases/securing-the-future-of-payments-pci-ssc-publishes-pci-data-security-standard-v4-0/) to ground payment-data security and validation standard.

## What I would set out to accomplish

- I would map merchants, consumers, acquirers, issuers, rails, and regulators in the network.
- I would separate volume growth from durable economics, interoperability, security, and switching costs.
- I would diligence fraud, authentication, dispute handling, data protection, and operational resilience.
- I would stage investment and integration around verified merchant utility and control readiness.
...
I would map merchants, consumers, acquirers, issuers, rails, and regulators in the network. I would translate each material requirement into a control owner, implementation evidence, test procedure, exception path, and release consequence. I would keep that control map connected to the delivery plan so that compliance review becomes part of the work rather than a late-stage handoff.

### How I would approach workstream 2

I would separate volume growth from durable economics, interoperability, security, and switching costs. I would translate each material requirement into a control owner, implementation evidence, test procedure, exception path, and release consequence. I would keep that control map connected to the delivery plan so that compliance review becomes part of the work rather than a late-stage handoff.

### How I would approach workstream 3

I would diligence fraud, authentication, dispute handling, data protection, and operational resilience. I would define the service objective, failure modes, capacity assumptions, instrumentation, and recovery path before I scale the change. I would use canaries and controlled stress to learn where the system breaks while the blast radius is still small.

### How I would approach workstream 4

I would stage investment and integration around verified merchant utility and control readiness. I would translate each material requirement into a control owner, implementation evidence, test procedure, exception path, and release consequence. I would keep that control map connected to the delivery plan so that compliance review becomes part of the work rather than a late-stage handoff.
...
|---|---|
| I would track active merchants | I would baseline this measure, assign an owner, review it by cohort or operating segment, and connect movement to a specific decision or corrective action. |
| I would track repeat payment use | I would use this to learn whether the intended audience reaches meaningful value, and I would segment it so aggregate growth cannot hide weak cohorts. |
| I would track success rate | I would baseline this measure, assign an owner, review it by cohort or operating segment, and connect movement to a specific decision or corrective action. |
| I would track fraud loss | I would use this to understand control effectiveness, severity, recurrence, and whether I need to stop, narrow, or redesign the rollout. |
| I would track dispute resolution | I would baseline this measure, assign an owner, review it by cohort or operating segment, and connect movement to a specific decision or corrective action. |
| I would track interoperability | I would baseline this measure, assign an owner, review it by cohort or operating segment, and connect movement to a specific decision or corrective action. |
| I would track unit economics | I would use this to test whether the operating model creates durable value after implementation, risk, and support costs are included. |
| I would track compliance gaps | I would baseline this measure, assign an owner, review it by cohort or operating segment, and connect movement to a specific decision or corrective action. |
...
|---|---|
| [World Bank - Fast Payments Toolkit (2021)](https://fastpayments.worldbank.org/sites/default/files/2021-11/Fast%20Payment%20Flagship_Final_Nov%201.pdf) | I use this source to ground market and implementation framework for fast payments, QR, APIs, risk, and interoperability. |
| [PCI SSC - PCI DSS 4.0 release (2022)](https://www.pcisecuritystandards.org/about_us/press_releases/securing-the-future-of-payments-pci-ssc-publishes-pci-data-security-standard-v4-0/) | I use this source to ground payment-data security and validation standard. |
